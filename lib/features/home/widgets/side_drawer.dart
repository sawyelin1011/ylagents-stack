...
class _SideDrawerState extends State<SideDrawer> with TickerProviderStateMixin {
  ...
  List<Conversation> _workspaceConversations(ChatService chatService) {
    return chatService.getConversationsForWorkspace(widget.workspaceId);
  }
          ...
          DesktopContextMenuItem(
            ...
            onTap: () async {
              ...
              try {
                ...
                if (currentAid != null) {
                  final all = _workspaceConversations(chatService);
                  final candidates =
                      all
                          .where(
                            (c) =>
  ...
  String? _nextRecentConversation(ChatService chatService, String excludeId) {
    try {
      ...
      final candidates =
          _workspaceConversations(chatService)
  ...
  Widget build(BuildContext context) {
    ...
    final conversations = _workspaceConversations(chatService)
        .where(
